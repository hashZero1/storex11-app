  ...
  return (
    <section className="xl:w-4/5 m-auto h-[90vh]">
      <div className="xl:mx-10 xl:mt-5 flex flex-col justify-between lg:flex-row  ">
        <div className="mt-5 xl:mt-10 tracking-wider z-20 text-slate-800 w-11/12 m-auto">
          ...
          <button
            ...
            className="mt-5 mb-10 px-5 py-2 xl:mt-10 xl:mb-0 xl:ml-2 xl:px-12 xl:py-4 rounded-full text-xl text-white font-semibold bg-red-600 hover:bg-gray-200 hover:text-black"
          >
            Browse Products
          </button>
        </div>
